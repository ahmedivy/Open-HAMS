...
>(({ className, ...props }, ref) => (
  ...
  >
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "flex h-8 w-full rounded-md border border-[#DBDBDB] bg-transparent px-3 py-1 text-sm shadow-sm transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground/90 placeholder:font-light placeholder:text-sm focus-visible:outline-none  disabled:cursor-not-allowed disabled:opacity-50",
        className,
      )}
      {...props}
    />
